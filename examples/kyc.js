...
(async () => {
    // request kyc authorization
    // please note that this key will only work on the testnet
    // KYC procedure will change on the mainnet
    ...
    let res = await API.kyc.isWhitelisted(kp.address)

    console.log(res)

    // fetch the account object, including the isApproved field
